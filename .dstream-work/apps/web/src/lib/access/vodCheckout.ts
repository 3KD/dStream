...
export type VodCheckoutVerificationMode =
  | "stake_verified"
  | "external_verified"
  | "operator_override"
  | "unverified_fallback";

export function formatVodCheckoutVerificationMode(mode: VodCheckoutVerificationMode | null | undefined): string | null {
...
export function normalizeVodPurchaseErrorMessage(
  message: string | null | undefined,
  policy: VodPurchasePolicy | null | undefined
): string {
