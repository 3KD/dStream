...
type OperatorConsoleMode = "operations" | "monetization" | "all";
...
export function OperatorConsole({ mode = "all" }: OperatorConsoleProps) {
  ...
  const showOperations = mode === "operations" || mode === "all";
  const showMonetization = mode === "monetization" || mode === "all";
  ...
  const headingTitle = mode === "operations" ? "Operations" : mode === "monetization" ? "Monetization" : "Operator Console";
