...
| Payments - Other Methods | 7 | ✅ | Native wallet requests plus backend verification for Lightning, UTXO, EVM/ERC-20, TRON/TRC-20, Solana/SPL, XRPL, and Cardano (ADR `0031`). |
