...
export function signVodAccessToken(payload: VodAccessTokenV1): string {
...
export function verifyVodAccessToken(token: string): VodAccessTokenV1 | null {
  ...
  if (obj.v !== 1 || obj.t !== "dstream_vod_access") return null;
