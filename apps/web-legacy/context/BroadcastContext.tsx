...
export function BroadcastProvider({ children }: { children: ReactNode }) {
    ...
    const [whipClientState, _setWhipClientState] = useState<WHIPClient | null>(null);
    const setWhipClient = (client: WHIPClient | null) => {
        if (client === null) {
            console.trace("[BroadcastContext] setWhipClient(null) called by:");
        }
        _setWhipClientState(client);
    };
    // Alias for context
    const whipClient = whipClientState;
