...
export function ChatBox({ channel, pubkey, broadcasterPubkey, adminPubkeys = [] }: {
    ...
    // Use responsive height to prevent layout shifts on mobile input
    return (
        <div className="flex flex-col h-[calc(100vh-250px)] min-h-[400px] border border-neutral-800 rounded-lg bg-neutral-900/50 overflow-hidden">
